...
type Helper struct {
	Help bool `cli:"!h,help" usage:"показать справочную информацию" json:"-"`
}
...
type Addr struct {
	Host string `cli:"host" usage:"укажите host" dft:"0.0.0.0"`
	Port uint16 `cli:"port" usage:"укажите port" dft:"8080"`
}

// Deprecated: AddrWithShort is builtin host,port flag contains short flag
type AddrWithShort struct {
	Host string `cli:"H,host" usage:"укажите host" dft:"0.0.0.0"`
	Port uint16 `cli:"p,port" usage:"укажите port" dft:"8080"`
}
